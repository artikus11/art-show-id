...
<div class="copy-button-wrapper" style="display: flex;flex-direction: column;align-items: flex-start;justify-content: center;">
	<button type="button"
	        class="button copy-button item-id"
	        data-clipboard-text="<?php echo esc_attr( $post_id ); ?>"
	        style="display: flex;align-items: center;justify-content: space-between;">
		<svg viewBox="0 0 896 1024" style="width: 14px;fill: #666161;margin-right: 5px">
		...
		</svg><?php echo esc_attr( $post_id ); ?></button>
